...
class InstrumentationMapping:
    ...
    def __init__(self, mapper : dict[str, Callable[[Event], list[Event] | None]], ignore_other : bool = False):
        self.mapper       = mapper
...
class PEP:
    ...
    def __init__(
        ...
        instrumentation_mapping : InstrumentationMapping | None                     = None,
    ):
        ...
        self.event_mapper  = \
            instrumentation_mapping if instrumentation_mapping is not None \
            else InstrumentationMapping({})
